...
require_dispatcher = require_role([UserRole.DISPATCHER, UserRole.ADMIN, UserRole.SUPER_ADMIN])
require_driver = require_role([UserRole.DRIVER, UserRole.ADMIN, UserRole.SUPER_ADMIN])
